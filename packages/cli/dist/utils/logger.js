...
export class Logger {
    ...
    showProjectGuidance() {
        ...
        this.command("npm create vite@latest my-polkadot-app -- --template react-ts");
        this.command("cd my-polkadot-app");
     ...
     */
    showNextSteps(componentName, hasPolkadotSetup = false) {
        this.newline();
        ...
        this.code(`import { ${componentName} } from '@/components/${componentName}'`);
        this.newline();
        ...
        if (hasPolkadotSetup) {
            ...
            this.code(`import { PolkadotProvider } from '@/providers/polkadot-provider'`);
            this.code(``);
