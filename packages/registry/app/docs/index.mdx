...
Polkadot UI is a comprehensive component library for building Polkadot applications. Think of it as **shadcn/ui for Web3** - a collection of beautifully designed, accessible components specifically tailored for the Polkadot ecosystem.
...
To use the component in your own project, you need to wrap your app or parts of it in a provider like this:
...
Every component is available in a self-contained version e.g. `<AddressInputWithProvider />`. It does not require any additional setup and is meant for demo purpses. If you want to use the component in your own project, don't use the self-contained version as it will duplicate chain connections.
</InfoBox>
...
- 🌐 **Website**: [dot-ui.com](https://polkadot-ui.com)
- 💻 **GitHub**: [Polkadot-UI-Initiative/polkadot-ui](https://github.com/Polkadot-UI-Initiative/polkadot-ui)
- 💬 **Telegram**: [Telegram](https://t.me/+455fEPCb3ftlM2M6)
...
- Open an issue on [GitHub](https://github.com/Polkadot-UI-Initiative/polkadot-ui/issues)
