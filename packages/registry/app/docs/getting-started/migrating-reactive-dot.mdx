---
title: From reactive-dot/papi Apps
...
This guide helps you adopt Polkadot UI in an existing <Link href="https://github.com/buffed-labs/reactive-dot">Reactive Dot</Link> project incrementally.
...
Then add the following to your vite.config.ts:
