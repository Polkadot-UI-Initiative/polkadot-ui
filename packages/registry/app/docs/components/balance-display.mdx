...
import { BalanceDisplayDocs } from "@/components/docs/docs-balance-display";

## Introduction

BalanceDisplay is a component for displaying balances from
supported chains with real-time balance display and optional comparison currency.
