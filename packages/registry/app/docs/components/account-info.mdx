...
The Account Info component additionally depends on <Link href="https://tanstack.com/query/latest">tanstack react-query</Link> to fetch data. So you will need to wrap your app in a <code>QueryClientProvider</code>.
