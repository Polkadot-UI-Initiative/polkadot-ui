...
import { SimpleTxButtonWithProvider } from "@/registry/polkadot-ui/blocks/tx-notification/components/simple-tx-button";
...
- Shows loader to indicate processing
...
const txUrl = `${explorerUrls.subscan}/extrinsic/${blockNumber}-${txIndex}`;
